        ...
        <div className="space-y-3">
          ...
          <div className="p-3 rounded-xl bg-white/3 border border-white/8 text-left">
            <p className="text-xs font-semibold text-gray-400 mb-2">
              Required disclosure (Apple App Store)
            </p>
            <p className="text-xs text-gray-500 leading-relaxed">
              Subscription title, length, and price are shown in the app before
              purchase. By subscribing you confirm you have read and agree to
              our{" "}
              <a
                href="/noury/privacy"
              ...
              and these Terms of Service. Cancel any time in{" "}
      ...
      content: (
        <div className="space-y-3 text-sm text-gray-400 leading-relaxed text-left">
          <p>
            ...
            jurisdiction — however, this does not affect any mandatory consumer
            protection rights you may have under the law of your country of
            habitual residence.
          </p>
          <p>
